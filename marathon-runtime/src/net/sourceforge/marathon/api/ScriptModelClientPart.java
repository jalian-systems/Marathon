...
public abstract class ScriptModelClientPart {

    private static IScriptModelClientPart instance;
    ...
    private static IScriptModelClientPart getModel(String selectedScript) throws ClassNotFoundException, InstantiationException,
            IllegalAccessException {
        Class<?> klass = Class.forName(selectedScript);
        return (IScriptModelClientPart) klass.newInstance();
    }

    public static IScriptModelClientPart getModel() {
        if (instance == null)
            initialize();
        return instance;
    }
