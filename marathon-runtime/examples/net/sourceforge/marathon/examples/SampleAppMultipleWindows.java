...
public class SampleAppMultipleWindows extends JFrame {
    ...
    public SampleAppMultipleWindows() {
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                JOptionPane.showMessageDialog(SampleAppMultipleWindows.this, "To save or not to save is the question ?",
        ...
        loadButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                JOptionPane.showMessageDialog(SampleAppMultipleWindows.this, "Open the Pandora's Box", "Load",
    ...
    private JMenuBar createMenuBar(final Component parent) {
        ...
        item = new JMenuItem("Bring the parent to front");
        ...
        item = new JMenuItem("New Non Modal Window");
        item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F1, KeyEvent.ALT_DOWN_MASK));
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JDialog dialog;
                if (parent instanceof Frame)
                    dialog = new JDialog((Frame) parent, "Another Window " + windowCount++);
                else if (parent instanceof Dialog)
                    dialog = new JDialog((Dialog) parent, "Another Window " + windowCount++);
                else
                    dialog = new JDialog((Frame) null, "Another Window " + windowCount++);
                dialog.getContentPane().add(new JScrollPane(createSimpleWidgetPanel()));
        ...
        item = new JMenuItem("New Modal Window");
        item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F2, KeyEvent.ALT_DOWN_MASK));
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JDialog dialog;
                if (parent instanceof Frame)
        ...
        item = new JMenuItem("New Non Modal Window (Without Parent)");
        item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F3, KeyEvent.ALT_DOWN_MASK));
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JDialog dialog;
                dialog = new JDialog((Frame) null, "Another Window " + windowCount++);
        ...
        item = new JMenuItem("New Modal Window (Without Parent)");
        ...
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(parent, "Marathon Test Demo version 1.0", "About Marathon Demo",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        });
    ...
    private JPanel createSimpleWidgetPanel() {
        ...
        String[] income = { "<10K", "Between 10K and 20K", "Between 20K and 30K", "Between 30K and 50K", "Between 50K and 70K",
                "Between 70K and 90K", "Between 90K and 100K", "Between 100K and 120K", "Between 120K and 140K",
                "Between 140K and 160K" };
    ...
    private JPanel createChooserPanel() {
        ...
        browse.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int ret = chooser.showOpenDialog(SampleAppMultipleWindows.this);
        ...
        color.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Color color = JColorChooser.showDialog(SampleAppMultipleWindows.this, "Chose a Color", Color.BLACK);
                if (color != null) {
