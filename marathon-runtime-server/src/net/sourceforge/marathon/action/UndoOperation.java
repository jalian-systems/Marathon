...
public class UndoOperation extends AbstractMarathonAction {
    ...
    public IScriptElement enscript(MComponent component) {
        return new UndoRecordable(component, action.enscript(component));
    }

    public IScriptElement enscript(WindowId id) {
        return new UndoRecordable(id, action.enscript(id));
    }
