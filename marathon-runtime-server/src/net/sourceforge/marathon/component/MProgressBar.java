...
public class MProgressBar extends MComponent {
    public MProgressBar(Component component, String name, ComponentFinder finder, WindowMonitor windowMonitor) {
        super(component, name, finder, windowMonitor);
    }

    private JProgressBar getProgressBar() {
        return ((JProgressBar) getComponent());
    }

    public String getText() {
        int value = eventQueueRunner.invokeInteger(getProgressBar(), "getValue");
        return "" + value;
    }
