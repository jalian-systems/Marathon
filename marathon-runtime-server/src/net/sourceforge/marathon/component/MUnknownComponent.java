...
public class MUnknownComponent extends MComponent {
    ...
    public MUnknownComponent(Component component, String name, ComponentFinder finder, WindowMonitor windowMonitor) {
