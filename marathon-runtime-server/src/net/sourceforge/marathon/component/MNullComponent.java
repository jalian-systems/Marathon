...
public class MNullComponent extends MComponent {
    public MNullComponent(Component component, String name, ComponentFinder finder, WindowMonitor windowMonitor) {
