...
SET CLASSPATH=%DIST%;%DIST%marathon.jar;%DIST%jython\jython.jar;%DIST%jruby\lib\jruby.jar;%DIST%jython\jython.jar;%DIST%jruby-parser\dist\JRubyParser.jar
SET CLASSPATH=%CLASSPATH%;%DIST%support/forms-1.2.1/forms-1.2.1.jar;%DIST%support/jaccess-1.3/jaccess.jar;%DIST%support/jline-0.9.93.jar;%DIST%support/junit4.8.2/junit-4.8.2.jar;%DIST%support/looks-2.2.0/looks-2.2.0.jar;%DIST%support/vldocking-3.0.0/src/jar/vldocking-3.0.0.jar;%DIST%support/guice-2.0/guice-2.0.jar;%DIST%support/guice-2.0/aopalliance.jar;%DIST%support/BrowserLauncher2-all-1_3.jar;%DIST%support/RSyntaxTextArea/dist/rsyntaxtextarea.jar;%DIST%support/snakeyaml/target/snakeyaml-1.7.jar;%DIST%support/osxutil/dist/osxutil.jar;%DIST%support/opencsv/deploy/opencsv-2.2.jar
