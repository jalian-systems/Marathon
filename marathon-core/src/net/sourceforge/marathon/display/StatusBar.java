...
public class StatusBar extends JPanel implements IStatusBar {
    ...
    public StatusBar() {
        FormLayout layout = new FormLayout("fill:pref:grow, min, pref, pref, pref", "pref");
        setLayout(layout);
        ...
        add(fixtureLabel, constraints.xy(2, 1));
        rowLabel = createLabel("9999");
        add(rowLabel, constraints.xy(3, 1));
        columnLabel = createLabel("9999");
        add(columnLabel, constraints.xy(4, 1));
        insertLabel = createLabel(" Overwrite ");
        add(insertLabel, constraints.xy(5, 1));
