...
public class RuntimeFactoryStub implements IRuntimeFactory {
    public IConsole console;
    public RuntimeStub runtimeStub;
    public boolean scriptsFail;

    public RuntimeFactoryStub() {
    }

    public IMarathonRuntime createRuntime(IRuntimeProfile profile, IConsole console) {
        this.console = console;
        runtimeStub = new RuntimeStub();
        runtimeStub.scriptsFail = scriptsFail;
        return runtimeStub;
    }
}
